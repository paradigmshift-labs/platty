...
함께 [문제 제보 및 지원 요청](https://github.com/paradigmshift-labs/platty/issues/new?template=platty-feedback.yml)을
등록해 주세요.
...
- 목록에 없는 언어, 프레임워크, 라이브러리 또는 저장소 구조는
  [문제 제보 및 지원 요청](https://github.com/paradigmshift-labs/platty/issues/new?template=platty-feedback.yml)에
  등록해 주세요.
- 제공되는 분석기에서 라우트, 모델, 관계 또는 저장소 간 연결이 누락되거나 잘못
  인식되면 같은 [문제 제보 및 지원 요청](https://github.com/paradigmshift-labs/platty/issues/new?template=platty-feedback.yml)을
  등록해 주세요.
